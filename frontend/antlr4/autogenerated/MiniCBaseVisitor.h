...
public:
  ...
  virtual std::any visitFormalParamDims(MiniCParser::FormalParamDimsContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitConstDeclNoSemi(MiniCParser::ConstDeclNoSemiContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitArrayDefDims(MiniCParser::ArrayDefDimsContext *ctx) override {
    return visitChildren(ctx);
  }
