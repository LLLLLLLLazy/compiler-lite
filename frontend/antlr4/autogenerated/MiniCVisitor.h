...
public:
   ...
   */
    ...
    virtual std::any visitFormalParamDims(MiniCParser::FormalParamDimsContext *context) = 0;
    ...
    virtual std::any visitArrayDefDims(MiniCParser::ArrayDefDimsContext *context) = 0;
